      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
          ...
          <div>
            ...
            <a
              href="mailto:contato@blendagency.com.br"
            ...
            >
              ...
              contato@blendagency.com.br
              <ArrowUpRight className="transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
            </a>

            {/* Phone Contact */}
            <a
              href="tel:+5541995175019"
              className="group inline-flex items-center gap-3 text-xl text-gray-400 hover:text-indigo-400 transition-all duration-300 mt-4"
            >
              📱 (41) 99517-5019
            </a>
            ...
            <div className="grid grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://instagram.com/blendagencybr"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/company/blendagencybr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group w-12 h-12 border-2 border-white/20 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-indigo-500 hover:to-purple-500 hover:border-transparent transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(99,102,241,0.5)]"
                  >
                  ...
                  <a
                    href="https://wa.me/5541995175019"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group w-12 h-12 border-2 border-white/20 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-indigo-500 hover:to-purple-500 hover:border-transparent transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(99,102,241,0.5)]"
                  >
